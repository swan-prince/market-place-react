...
function CreateCategory({ categories, setPricingModels }) {
	...
	const [category_list, setCategoriesList] = useState([]);
					...
					<div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-200 border-0">
						<div className="rounded-t bg-white mb-0 px-6 py-6">
							<div className="text-center flex justify-between">
								<h6 className="text-gray-800 text-xl font-bold">Adding new category</h6>
								<button
							...
							<form>
								<div className="flex flex-wrap mt-5">
									<div className="w-full lg:w-12/12 px-4">
										<TextInput label = "Name" type = "text" name="name" onChange={ (e) => setName(e.target.value) } />
									</div>
									<div className="w-full lg:w-12/12 px-4">
										<TextInput label = "Slug" type = "text" name="slug" onChange={ (e) => setSlug(e.target.value) } />
									</div>
									<div className="w-full lg:w-12/12 px-4">
										<TextInput label = "Order" type = "number" name="order" onChange={ (e) => setOrder(e.target.value) } />
									</div>
									<div className="w-full lg:w-12/12 px-4">
